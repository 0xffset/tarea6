            ...
            <IonList>
                <IonItem>
                    <IonInput
                        ...
                        type="text"
                        value={pais}
                        onInput={(e: any) => setPais(e.target.value)}
                    ></IonInput>
                </IonItem>
                <IonInput>
                    <IonToolbar>
            ...
            <IonContent class="ion-margin">
                <IonGrid class="ion-margin">
                    ...
                    {resultado.map((valor, index) => (
                        <IonRow key={index}>
                            <IonCol>{valor?.name}</IonCol>
                            <IonCol>valor.domains[0]</IonCol>
                            <IonCol>valor.alpha_two_code</IonCol>
                            <IonCol>valor.web_pages[0]</IonCol>
                        </IonRow>
                    ))}
                </IonGrid>
